...
- Both the intercept and flipper_length_mm coefficients are significantly different from zero (not super interesting) **flipper length coefficient means that we expect bodymass to increase by 49.69 g for each 1 mm increase in flipper lenth. Intercept means for a penguing with 0 mm flipper length we expect an average penguin mass of -5788.83 grams**
...
**normality of residuals different from homoscedasticity?**
...
**what is the t(340)? where does this come from?
